...
class ExtractionCache:
    ...
    def _get_cache_key(self, file_path: str, project_root: str | None = None) -> str:
        """
    ...
    def get(self, file_path: str, project_root: str | None = None) -> dict[str, Any] | None:
        """
    ...
    def set(self, file_path: str, data: dict[str, Any], project_root: str | None = None) -> None:
        """
        ...
        try:
            ...
            self.cache_data[cache_key] = CacheEntry(
                file_path=file_path, mtime=stat.st_mtime, size=stat.st_size, data=data
            )
        except OSError as e:
    ...
    def clear(self) -> None:
        ...
        if self.enabled and self.cache_file.exists():
            try:
                ...
                print(
                    f"Warning: Could not delete cache file {self.cache_file}: {e}", file=sys.stderr
                )
